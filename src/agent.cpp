...
namespace fs {
    ...
    Agent::Agent(const protocol::RobotId &id, const navcon::RobotConstraints &constraints, navcon::TrackerType type,
    ...
    void Agent::set_goal(const navcon::NavigationGoal &goal) { tracker_->set_goal(goal); }
