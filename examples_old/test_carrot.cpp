...
int main(int argc, char *argv[]) {
    ...
    params.carrot_distance = 1.0f; // Distance to "carrot" target point
    ...
    drivekit::PathGoal path(straight_path, 3.0f, 3.0f, false); // Larger tolerance for simple algorithm
    ...
    drivekit::PathGoal zigzag_goal(zigzag_path, 3.0f, 3.0f, false);
