...
int main(int argc, char **argv) {
    ...
    robots.push_back(&sim.spawn_agent("examples/machines/urdf/tractor.urdf", utils::make_pose_2d(0.0, 0.0, 0.0),
                                      std::string("tractor_0"), pigment::RGB(0, 255, 100)));
    robots.push_back(&sim.spawn_agent("examples/machines/urdf/trailer.urdf", utils::make_pose_2d(0.0, -5.0, 0.0),
                                      std::string("trailer_0"), pigment::RGB(255, 150, 0)));
    robots.push_back(&sim.spawn_agent("examples/machines/urdf/oxbo_harvester.urdf", utils::make_pose_2d(10.0, 10.0, 0.0),
                                      std::string("oxbo_0"), pigment::RGB(255, 200, 0)));
    robots.push_back(&sim.spawn_agent("examples/machines/urdf/trailer.urdf", utils::make_pose_2d(0.0, -10.0, 0.0),
                                      std::string("trailer_1"), pigment::RGB(255, 100, 50)));
    robots.push_back(&sim.spawn_agent("examples/machines/urdf/truck.urdf", utils::make_pose_2d(20.0, 0.0, 0.0), std::string("truck_0"),
                                      pigment::RGB(100, 100, 255)));
    robots.push_back(&sim.spawn_agent("examples/machines/urdf/husky.urdf", utils::make_pose_2d(30.0, 10.0, 0.0), std::string("husky_0"),
