...
int main(int argc, char *argv[]) {
    ...
    // Load tractor
    try {
        // Start tractor close to the first waypoint and facing east
        // Robot coordinate system: 0° is north, so -90° (or -π/2) is east
        auto tractor_info =
            fs::Loader::load_from_json("examples/machines/tractor.json",
                                       concord::Pose{concord::Point{0.0f, 0.0f}, concord::Euler{0.0f, 0.0f, -M_PI/2}});
    ...
    // Create a path that starts close to the robot and tests Stanley's path following
    ...
    std::vector<concord::Point> complex_path = {
        {5.0f, 0.0f},   // Start going straight east
        {10.0f, 0.0f},  // Continue straight
        {15.0f, 0.0f},  // More straight to establish baseline
        {20.0f, 2.0f},  // Gentle turn to test cross-track correction
        {25.0f, 5.0f},  //
        {30.0f, 8.0f},  //
        {35.0f, 10.0f}, //
        {40.0f, 10.0f}, // Straight segment again
        {45.0f, 10.0f}, //
        {50.0f, 8.0f},  // Turn back down
        {55.0f, 5.0f},  //
        {60.0f, 2.0f},  //
        {65.0f, 0.0f},  // Back to horizontal
        {70.0f, -3.0f}, // Go below x-axis
        {75.0f, -6.0f}, //
        {80.0f, -8.0f}, // Bottom of path
        {85.0f, -6.0f}, // Turn back up
        {90.0f, -3.0f}, //
        {95.0f, 0.0f},  // Cross x-axis again
        {100.0f, 3.0f}, // Final climb
        {105.0f, 5.0f}  // End point
    };
