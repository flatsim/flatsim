...
namespace agent {
    ...
    class Loader {
      ...
      private:
        ...
        static void parse_hitches(types::Machine &machine, const boost::json::object &hitches_json);
        static void parse_tank(types::Machine &machine, const boost::json::object &tank_json);
        static void parse_power(types::Machine &machine, const boost::json::object &power_json);
        static void parse_capability(types::Machine &machine, const boost::json::object &capability_json);
