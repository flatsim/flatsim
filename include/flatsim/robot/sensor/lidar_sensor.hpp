...
namespace fs {
    ...
    struct LIDARData {
        ...
        // Sensor status
        enum class ScanStatus { IDLE = 0, SCANNING = 1, COMPLETE = 2, ERROR = 3 } scan_status = ScanStatus::IDLE;
    ...
    class LIDARSensor : public Sensor {
      ...
      public:
         ...
         */
        LIDARSensor(std::shared_ptr<muli::World> world, ScanPattern pattern = ScanPattern::CIRCULAR_2D,
                    double frequency = 10.0, double min_r = 0.1, double max_r = 30.0, double h_fov = 360.0,
                    double h_res = 1.0);
         ...
         */
        void configure_angular(double h_fov, double v_fov = 0.0, double h_res = 1.0, double v_res = 1.0);
         ...
         */
        void configure_noise(double range_noise = 0.01, double beam_div = 0.1, double dropout = 0.01);
         ...
         */
        void set_environmental_conditions(double rain = 0.0, double fog = 0.0, double dust = 0.0);
