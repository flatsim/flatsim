...
namespace fs {
    ...
    class MultiverseException : public std::runtime_error {
      public:
        explicit MultiverseException(const std::string &message) : std::runtime_error(message) {}
    };
    ...
    class PhysicsException : public MultiverseException {
      public:
        explicit PhysicsException(const std::string &message) : MultiverseException("Physics error: " + message) {}
    };
